    ...
    return (
        <section className="scroll-smooth focus:scroll-auto">
                ...
                <section className="mb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div className="p-6 rounded-lg interactive-card">
                            ...
                            <button onClick={() => toggleModal('/resources/Illustrations/donations.svg', <p> Support us by making a donation to help fund our initiatives and projects. Your contributions make a significant impact on our ability to achieve our goals.</p>)} className="text-current hover:text-accent mt-4 block">
                        ...
                        <div className="p-6 rounded-lg interactive-card">
                            ...
                            <button onClick={() => toggleModal('/resources/Illustrations/Fundraising.svg', <p>Organize fundraising events or campaigns to help us reach more people. Your efforts in fundraising make a significant difference in our ability to achieve our goals.</p>)} className="text-current hover:text-accent mt-4 block">More about fundraising →</button>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div className="p-6 border-2 rounded-lg interactive-card">
                            ...
                            <div className="mb-4 flex items-center space-x-4">
                                <button onClick={() => toggleModal('/resources/Illustrations/Mentorship.svg', <p>Become a mentor and help guide our youth in various technical and life skills. Your mentorship can make a lasting impact on the lives of young people.</p>)} className="text-current hover:text-accent mt-4 block">More about mentorship →</button>
                            </div>
                        </div>
                        <div className="p-6 border-2 rounded-lg interactive-card">
                            <div className="image">
                            ...
                            <div className="mb-4 flex items-center space-x-4">
                                <button onClick={() => toggleModal('/resources/Illustrations/Support.svg', <p>Offer your expertise in technical areas like software development, electronics, or robotics. Your technical support can help us achieve our goals more effectively.</p>)} className="text-current hover:text-accent mt-4 block">More about technical support →</button>
                            </div>
                        </div>
                        <div className="p-6 border-2 rounded-lg interactive-card">
                            <div className="image">
                            ...
                            <div className="mb-4 flex items-center space-x-4">
                                <button onClick={() => toggleModal('/resources/Illustrations/Eventplan.svg', <p>Help organize and coordinate events like workshops and competitions. Your event coordination skills can help us create impactful and successful events.</p>)} className="text-current hover:text-accent mt-4 block">More about event coordination →</button>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div className="p-6 border-2 rounded-lg interactive-card">
                            ...
                            <button onClick={() => toggleModal('/resources/Illustrations/Partnerships.svg', <p>Collaborate with us on large-scale projects or sponsor key events. Your corporate partnership can help us achieve our goals and make a significant impact.</p>)} className="text-current hover:text-accent mt-4 block">More about corporate partnerships →</button>
                        </div>
                        <div className="p-6 border-2 rounded-lg interactive-card">
                            <div className="image">
                                <ThemedImage
                            ...
                            <button onClick={() => toggleModal('/resources/Illustrations/Education.svg', <p>Partner with us to bring educational programs to students and communities. Your collaboration with educational institutions can help us reach more students and make a greater impact.</p>)} className="text-current hover:text-accent mt-4 block">More about educational partnerships →</button>
                        </div>
                        <div className="p-6 border-2 rounded-lg interactive-card">
                            <div className="image">
                                <ThemedImage
            ...
            <ReusableModal
                ...
                actions={
                    <>
                        <Button onClick={() => toggleModal()} className="bg-btn-bg text-btn-text hover:bg-btn-hover-bg focus:ring-4 focus:outline-none focus:ring-focus-ring font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                            Close
                        </Button>
                    </>
                }
