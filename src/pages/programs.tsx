...
const Programs: React.FC = () => {
  ...
  const days = [
    ...
    },
    {
      ...
      tools: [{ name: "All previous tools", icon: null }]
    }
  ];
  ...
  return (
    <>
      <SEOConfig
        title="Programs | Plastal-Bot Builders"
        description="Explore our robotics and technology programs designed to empower youth with hands-on learning experiences."
      ...
      <section className="scroll-smooth focus:scroll-auto">
        ...
        {tab === 'completed' && (
          <FadeContent blur={true} duration={800} easing="ease-out" initialOpacity={0} delay={0.1}>
        ...
        {tab === 'completed' && (
          <>
            {/* Spike Prime Section */}
            <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0} delay={0.2}>
              <div id="spike-prime" className="max-w-7xl mx-auto px-4 py-12">
              ...
              <div id="intro-workshop" className="max-w-7xl mx-auto px-4 py-12">
                ...
                <div className="mb-8">
                  <h2 className="type-h2 mb-3">
                    Introduction to Robotics and <span className="text-hex">Programming Workshop</span>
                  </h2>
                  ...
                  <div className="mt-6 rounded-xl overflow-hidden interactive-card">
                    <SmartImage
                      src="resources/IntroRoboticsWorkshop/IMG_4428.jpg"
                      alt="Learners building robots at the Introduction to Robotics and Programming Workshop"
        ...
        {tab === 'upcoming' && (
          <>
            {/* Hero Section */}
            <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0} delay={0.1}>
            ...
            {/* CTA Section */}
            <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0} delay={0.4}>
