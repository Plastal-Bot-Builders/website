                                ...
                                {blogPosts.map((post, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="mt-4">
                                            ...
                                            {/* Read More Button */}
                                            <a
                                                className="custom-button w-full inline-flex items-center justify-center"
                                                style={{ textDecoration: 'none' }}
                                                href="https://medium.com/@plastalbotbuilders"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                aria-label={`Read ${post.title} ${post.subtitle} on Medium (opens in a new tab)`}
                                            >
                                                Read on Medium →
                                            </a>
                                        </div>
