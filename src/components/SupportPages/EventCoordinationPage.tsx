                    ...
                    <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0} delay={200}>
                        <section id="volunteer" className="rounded-lg interactive-card overflow-hidden">
                            <div className="p-4 sm:p-6 lg:p-8">
                                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6">Volunteer as an Event Coordinator</h2>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                                    <div className="space-y-4 sm:space-y-6">
                                        ...
                                        <div>
                                            <h3 className="font-bold mb-2 sm:mb-3 text-base sm:text-lg">What you'll gain:</h3>
                                            <ul className="space-y-2">
                                                <li className="flex items-start">
                                                    <span className="text-accent mr-2 flex-shrink-0">•</span>
                                                    <span className="text-xs sm:text-sm">Hands-on event management experience</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="text-accent mr-2 flex-shrink-0">•</span>
                                                    <span className="text-xs sm:text-sm">Technical skills in robotics and technology</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="text-accent mr-2 flex-shrink-0">•</span>
                                                    <span className="text-xs sm:text-sm">Network with industry professionals and educators</span>
                                                </li>
                                                <li className="flex items-start">
                                                    <span className="text-accent mr-2 flex-shrink-0">•</span>
                                                    <span className="text-xs sm:text-sm">Make a difference in young people's lives</span>
                                                </li>
                                            </ul>
                                        </div>
                                        
                                        <div className="bg-surface-hover-bg p-4 rounded-lg">
                                            <h3 className="font-bold mb-2 text-sm sm:text-base">Event Team Contact:</h3>
                                            <p className="text-xs sm:text-sm">Emmanuel Mwaba</p>
                                            <p className="text-xs sm:text-sm">Event Coordination Lead</p>
                                            <a href="mailto:events@plastalbotbuilders.org" className="text-accent hover:underline text-xs sm:text-sm">
                                                events@plastalbotbuilders.org
                                            </a>
                                            <p className="text-xs sm:text-sm">+260 97 9876543</p>
                                        </div>
                                    </div>
                                    
                                    <form className="space-y-4">
                                        <div>
                                            <label htmlFor="full-name" className="block mb-2 text-sm sm:text-base font-medium">Full Name</label>
                                            <input 
                                                type="text" 
                                                id="full-name" 
                                        ...
                                        <div>
                                            <label htmlFor="email" className="block mb-2 text-sm sm:text-base font-medium">Email</label>
                                            <input 
                                                type="email" 
                                                id="email" 
                                                className="w-full p-2 sm:p-3 rounded-lg border border-surface-border bg-surface text-sm sm:text-base"
                                        ...
                                        <div>
                                            <label htmlFor="phone" className="block mb-2 text-sm sm:text-base font-medium">Phone Number</label>
                                            <input 
                                                type="tel" 
                                                id="phone" 
                                                className="w-full p-2 sm:p-3 rounded-lg border border-surface-border bg-surface text-sm sm:text-base"
                                        ...
                                        <div>
                                            <label htmlFor="skills" className="block mb-2 text-sm sm:text-base font-medium">Skills & Experience</label>
                                            <select 
                                                id="skills" 
                                                className="w-full p-2 sm:p-3 rounded-lg border border-surface-border bg-surface text-sm sm:text-base mb-2"
                                                multiple
                                            >
                                            ...
                                            <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Hold Ctrl/Cmd to select multiple options</p>
                                        </div>
                                        
                                        <div>
                                            <label htmlFor="availability" className="block mb-2 text-sm sm:text-base font-medium">Availability</label>
                                            <select 
                                                id="availability" 
                                                className="w-full p-2 sm:p-3 rounded-lg border border-surface-border bg-surface text-sm sm:text-base"
                                            >
                                        ...
                                        <div>
                                            <label htmlFor="message" className="block mb-2 text-sm sm:text-base font-medium">Why you'd like to volunteer</label>
                                            <textarea 
                                                id="message" 
                                                rows={3}
                                                className="w-full p-2 sm:p-3 rounded-lg border border-surface-border bg-surface text-sm sm:text-base"
