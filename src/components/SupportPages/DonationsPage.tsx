...
const DonationsPage: React.FC = () => {
    ...
    return (
        <>
            <SEOConfig
                title="Donations | Plastal-Bot Builders"
                            ...
                            <div className="mt-8">
                                ...
                                <div className="mt-4 flex flex-col sm:flex-row sm:items-center gap-3 text-sm">
                                    <div className="border border-surface-border p-2 rounded flex items-center flex-wrap gap-2 bg-white dark:bg-gray-800">
                                        ...
                                        />
                                        <SmartImage 
                                            src="resources/Logo/New-mtn-logo.jpg" 
                                            alt="MTN Mobile Money" 
                                            className="h-4 w-4 sm:h-5 sm:w-5 object-contain"
                                            loading="lazy"
                                        />
                                        <SmartImage 
                                            src="resources/Logo/Airtel_logo-01.png" 
                                            alt="Airtel Money" 
                                            className="h-4 w-4 sm:h-5 sm:w-5 object-contain"
                                            loading="lazy"
                                        />
                                        <SmartImage 
                                            src="resources/Logo/images.png" 
                                            alt="Stripe" 
                                            className="h-4 w-4 sm:h-5 sm:w-5 object-contain"
                                            loading="lazy"
                                        />
                        ...
                        <section className="mb-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="rounded-lg interactive-card p-6">
                                    ...
                                    <SmartImage
                                        src="resources/Photos/IMG_5087.jpg"
                                        alt="Recent workshop in Ndola"
                                        className="w-full h-32 sm:h-40 object-cover rounded-lg mb-3"
                                        loading="lazy"
                                    />
                                    <Link to="/news" className="text-accent hover:underline">See more photos →</Link>
                                </div>
                                ...
                                <div className="rounded-lg interactive-card p-6">
                                    ...
                                    <Link to="/news" className="text-accent hover:underline">See our latest updates →</Link>
                                </div>
                            </div>
                        </section>
                    </FadeContent>
