        ...
        <section className="scroll-smooth focus:scroll-auto">
            ...
            <div className="max-w-7xl mx-auto p-8">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-6 pb-2">The Power of Partnership</h2>
                ...
                {/* Partnership Types */}
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-6 pb-2">Collaboration Opportunities</h2>
                ...
                <section id="current-partners" className="mb-12">
                    <h2 className="text-2xl font-bold mb-6 pb-2">Featured Partnerships</h2>
                ...
                {/* SDG Alignment */}
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-6 pb-2">Aligned with Global Goals</h2>
                ...
                {/* Partnership Process */}
                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-6 pb-2">Partnership Process</h2>
