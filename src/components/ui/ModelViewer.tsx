...
// ✅ Separate loader components for each file type
...
const ModelInner: FC<ModelInnerProps> = ({
  ...
  }, [camera, pivot, initPitch, initYaw, autoFrame, fadeIn, onLoaded]);
  ...
  // ✅ Render appropriate model component based on extension
  return (
    <group ref={outer}>
      <group ref={inner}>
        {(ext === 'glb' || ext === 'gltf') && <GLTFModel url={url} />}
