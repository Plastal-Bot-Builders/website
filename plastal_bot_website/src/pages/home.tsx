                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 grid-rows-2 gap-4">
                                ...
                                <div
                                    ...
                                    <p className="text-sm text-gray-100">The applications of
                                    ...
                                    <p className="mt-4 text-sm text-gray-100">As robotics
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 grid-rows-2 gap-4">
                                ...
                                <div
                                    ...
                                    <p className="text-sm text-gray-100">Robotics is used in
